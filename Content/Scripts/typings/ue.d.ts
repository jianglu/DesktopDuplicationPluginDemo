...
declare type ELowEntryHttpRequestSuccess = string | symbol;
declare var ELowEntryHttpRequestSuccess = { Success:'Success',Failed:'Failed', };
declare class LowEntryHttpRequestResponse extends UObject { 
	Successful: boolean;
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): LowEntryHttpRequestResponse;
	static Find(Outer: UObject, ResourceName: string): LowEntryHttpRequestResponse;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): LowEntryHttpRequestResponse;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): LowEntryHttpRequestResponse;
	WasRequestSuccessful(Branch?: ELowEntryHttpRequestSuccess): {Branch: ELowEntryHttpRequestSuccess};
	GetWasRequestSuccessful(): boolean;
	GetUrl(): string;
	...
	GetContentAsBytes(): number[];
	GetAllHeaders(): string[];
	static C(Other: UObject): LowEntryHttpRequestResponse;
}

declare type ELowEntryHttpRequestType = string | symbol;
declare var ELowEntryHttpRequestType = { GET:'GET',POST:'POST',PUT:'PUT', };
declare class LowEntryHttpRequest extends UObject { 
	UrlParameters: any;
	ContentStringParameters: any;
	JsonData: boolean;
	KeepAliveCount: number;
	ExecutionEvent: UnrealEngineDelegate<(Response: LowEntryHttpRequestResponse) => void>;
	ExecutionResponse: LowEntryHttpRequestResponse;
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): LowEntryHttpRequest;
	static Find(Outer: UObject, ResourceName: string): LowEntryHttpRequest;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): LowEntryHttpRequest;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): LowEntryHttpRequest;
	SetUrlParameter(Key: string,Value: string): void;
	SetUrl(Type: ELowEntryHttpRequestType,Url: string): void;
	SetHeader(Key: string,Value: string): void;
	SetContentAsStringParameters(Key: string,Value: string): void;
	SetContentAsString(Data: string): void;
	SetContentAsJsonString(Data: string): void;
	SetContentAsBytes(Data: number[]): void;
	IsRequestExecuting(): boolean;
	ExecuteRequest(WorldContextObject: UObject,LatentInfo: LatentActionInfo,Response?: LowEntryHttpRequestResponse): {Response: LowEntryHttpRequestResponse};
	CancelRequestExecution(): void;
	static C(Other: UObject): LowEntryHttpRequest;
}

declare class LowEntryHttpRequestLibrary extends BlueprintFunctionLibrary { 
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): LowEntryHttpRequestLibrary;
	static Find(Outer: UObject, ResourceName: string): LowEntryHttpRequestLibrary;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): LowEntryHttpRequestLibrary;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): LowEntryHttpRequestLibrary;
	static Create(): LowEntryHttpRequest;
	static C(Other: UObject): LowEntryHttpRequestLibrary;
}

declare class LowEntryJsonDebugLibrary extends BlueprintFunctionLibrary { 
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): LowEntryJsonDebugLibrary;
	static Find(Outer: UObject, ResourceName: string): LowEntryJsonDebugLibrary;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): LowEntryJsonDebugLibrary;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): LowEntryJsonDebugLibrary;
	static PrintString(WorldContextObject: UObject,String: string,Label: string,ScreenDurationTime: number,bPrintToScreen: boolean,bPrintToLog: boolean,TextColor: LinearColor): void;
	static PrintStringArray(WorldContextObject: UObject,StringArray: string[],Label: string,ScreenDurationTime: number,bPrintToScreen: boolean,bPrintToLog: boolean,TextColor: LinearColor): void;
	static PrintJsonValueArray(WorldContextObject: UObject,JsonValueArray: LowEntryJsonValue[],Label: string,ScreenDurationTime: number,bPrintToScreen: boolean,bPrintToLog: boolean,TextColor: LinearColor): void;
	static PrintJsonValue(WorldContextObject: UObject,JsonValue: LowEntryJsonValue,Label: string,ScreenDurationTime: number,bPrintToScreen: boolean,bPrintToLog: boolean,TextColor: LinearColor): void;
	static PrintJsonObjectArray(WorldContextObject: UObject,JsonObjectArray: LowEntryJsonObject[],Label: string,ScreenDurationTime: number,bPrintToScreen: boolean,bPrintToLog: boolean,TextColor: LinearColor): void;
	static PrintJsonObject(WorldContextObject: UObject,JsonObject: LowEntryJsonObject,Label: string,ScreenDurationTime: number,bPrintToScreen: boolean,bPrintToLog: boolean,TextColor: LinearColor): void;
	static PrintJsonArrayArray(WorldContextObject: UObject,JsonArrayArray: LowEntryJsonArray[],Label: string,ScreenDurationTime: number,bPrintToScreen: boolean,bPrintToLog: boolean,TextColor: LinearColor): void;
	static PrintJsonArray(WorldContextObject: UObject,JsonArray: LowEntryJsonArray,Label: string,ScreenDurationTime: number,bPrintToScreen: boolean,bPrintToLog: boolean,TextColor: LinearColor): void;
	static PrintIntegerArray(WorldContextObject: UObject,IntegerArray: number[],Label: string,ScreenDurationTime: number,bPrintToScreen: boolean,bPrintToLog: boolean,TextColor: LinearColor): void;
	static PrintInteger(WorldContextObject: UObject,Integer: number,Label: string,ScreenDurationTime: number,bPrintToScreen: boolean,bPrintToLog: boolean,TextColor: LinearColor): void;
	static PrintFloatArray(WorldContextObject: UObject,FloatArray: number[],Label: string,ScreenDurationTime: number,bPrintToScreen: boolean,bPrintToLog: boolean,TextColor: LinearColor): void;
	static PrintFloat(WorldContextObject: UObject,Float: number,Label: string,ScreenDurationTime: number,bPrintToScreen: boolean,bPrintToLog: boolean,TextColor: LinearColor): void;
	static PrintByteArray(WorldContextObject: UObject,ByteArray: number[],Label: string,ScreenDurationTime: number,bPrintToScreen: boolean,bPrintToLog: boolean,TextColor: LinearColor): void;
	static PrintByte(WorldContextObject: UObject,Byte: number,Label: string,ScreenDurationTime: number,bPrintToScreen: boolean,bPrintToLog: boolean,TextColor: LinearColor): void;
	static PrintBooleanArray(WorldContextObject: UObject,BooleanArray: boolean[],Label: string,ScreenDurationTime: number,bPrintToScreen: boolean,bPrintToLog: boolean,TextColor: LinearColor): void;
	static PrintBoolean(WorldContextObject: UObject,Boolean: boolean,Label: string,ScreenDurationTime: number,bPrintToScreen: boolean,bPrintToLog: boolean,TextColor: LinearColor): void;
	static C(Other: UObject): LowEntryJsonDebugLibrary;
}

declare class LowEntryJsonObjectEntry extends UObject { 
	Key: string;
	Value: LowEntryJsonValue;
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): LowEntryJsonObjectEntry;
	static Find(Outer: UObject, ResourceName: string): LowEntryJsonObjectEntry;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): LowEntryJsonObjectEntry;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): LowEntryJsonObjectEntry;
	static C(Other: UObject): LowEntryJsonObjectEntry;
}

declare type ELowEntryJsonParseResult = string | symbol;
declare var ELowEntryJsonParseResult = { FoundObject:'FoundObject',FoundArray:'FoundArray',StringIsEmpty:'StringIsEmpty',UnableToParse:'UnableToParse', };
declare class LowEntryJsonLibrary extends BlueprintFunctionLibrary { 
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): LowEntryJsonLibrary;
	static Find(Outer: UObject, ResourceName: string): LowEntryJsonLibrary;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): LowEntryJsonLibrary;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): LowEntryJsonLibrary;
	static SetString(JsonValue: LowEntryJsonValue,Value: string): void;
	static SetNull(JsonValue: LowEntryJsonValue): void;
	static SetJsonObject(JsonValue: LowEntryJsonValue,Value: LowEntryJsonObject): void;
	static SetJsonArray(JsonValue: LowEntryJsonValue,Value: LowEntryJsonArray): void;
	static SetInteger(JsonValue: LowEntryJsonValue,Value: number): void;
	static SetFloat(JsonValue: LowEntryJsonValue,Value: number): void;
	static SetByte(JsonValue: LowEntryJsonValue,Value: number): void;
	static SetBoolean(JsonValue: LowEntryJsonValue,Value: boolean): void;
	static SetJsonValue(JsonValue: LowEntryJsonValue,Value: LowEntryJsonValue): void;
	static CreateJsonValue(Value: string): LowEntryJsonValue;
	static CreateJsonValue(): LowEntryJsonValue;
	static CreateJsonValue(Value: LowEntryJsonObject): LowEntryJsonValue;
	static CreateJsonValue(Value: LowEntryJsonArray): LowEntryJsonValue;
	static CreateJsonValue(Value: number): LowEntryJsonValue;
	static CreateJsonValue(Value: number): LowEntryJsonValue;
	static CreateJsonValue(Value: number): LowEntryJsonValue;
	static CreateJsonValue(Value: boolean): LowEntryJsonValue;
	static CreateJsonValue(): LowEntryJsonValue;
	static Clone(JsonValue: LowEntryJsonValue): LowEntryJsonValue;
	static GetString(JsonValue: LowEntryJsonValue,Branch?: ELowEntryJsonTypeFound): {Branch: ELowEntryJsonTypeFound, $: string};
	static GetNull(JsonValue: LowEntryJsonValue,Branch?: ELowEntryJsonTypeFound): {Branch: ELowEntryJsonTypeFound};
	static GetJsonObject(JsonValue: LowEntryJsonValue,Branch?: ELowEntryJsonTypeFound): {Branch: ELowEntryJsonTypeFound, $: LowEntryJsonObject};
	static GetJsonArray(JsonValue: LowEntryJsonValue,Branch?: ELowEntryJsonTypeFound): {Branch: ELowEntryJsonTypeFound, $: LowEntryJsonArray};
	static GetInteger(JsonValue: LowEntryJsonValue,Branch?: ELowEntryJsonTypeFound): {Branch: ELowEntryJsonTypeFound, $: number};
	static GetFloat(JsonValue: LowEntryJsonValue,Branch?: ELowEntryJsonTypeFound): {Branch: ELowEntryJsonTypeFound, $: number};
	static GetByte(JsonValue: LowEntryJsonValue,Branch?: ELowEntryJsonTypeFound): {Branch: ELowEntryJsonTypeFound, $: number};
	static GetBoolean(JsonValue: LowEntryJsonValue,Branch?: ELowEntryJsonTypeFound): {Branch: ELowEntryJsonTypeFound, $: boolean};
	static GetAsString(JsonValue: LowEntryJsonValue,Default: string): string;
	static GetAsJsonObject(JsonValue: LowEntryJsonValue,Default: LowEntryJsonObject): LowEntryJsonObject;
	static GetAsJsonArray(JsonValue: LowEntryJsonValue,Default: LowEntryJsonArray): LowEntryJsonArray;
	static GetAsInteger(JsonValue: LowEntryJsonValue,Default: number): number;
	static GetAsFloat(JsonValue: LowEntryJsonValue,Default: number): number;
	static GetAsByte(JsonValue: LowEntryJsonValue,Default: number): number;
	static GetAsBoolean(JsonValue: LowEntryJsonValue,Default: boolean): boolean;
	static Get(JsonValue: LowEntryJsonValue,Branch?: ELowEntryJsonType,ReturnStringValue?: string,ReturnIntegerValue?: number,ReturnFloatValue?: number,ReturnByteValue?: number,ReturnBooleanValue?: boolean,ReturnJsonObjectValue?: LowEntryJsonObject,ReturnJsonArrayValue?: LowEntryJsonArray): {Branch: ELowEntryJsonType, ReturnStringValue: string, ReturnIntegerValue: number, ReturnFloatValue: number, ReturnByteValue: number, ReturnBooleanValue: boolean, ReturnJsonObjectValue: LowEntryJsonObject, ReturnJsonArrayValue: LowEntryJsonArray};
	static CreateJsonValue(Value: string): LowEntryJsonValue;
	static CreateJsonValue(): LowEntryJsonValue;
	static CreateJsonValue(Value: LowEntryJsonObject): LowEntryJsonValue;
	static CreateJsonValue(Value: LowEntryJsonArray): LowEntryJsonValue;
	...
	static CreateJsonValue(): LowEntryJsonValue;
	static Clone(JsonValue: LowEntryJsonValue): LowEntryJsonValue;
	static Length(JsonObjectIterator: LowEntryJsonObjectIterator): number;
	static GetValues(JsonObjectIterator: LowEntryJsonObjectIterator): LowEntryJsonArray;
	static GetKeys(JsonObjectIterator: LowEntryJsonObjectIterator): string[];
	static Get(JsonObjectIterator: LowEntryJsonObjectIterator,Index: number,Key?: string,JsonValue?: LowEntryJsonValue,Branch?: ELowEntryJsonValueFound): {Key: string, JsonValue: LowEntryJsonValue, Branch: ELowEntryJsonValueFound};
	static CreateJsonObjectIterator(JsonObject: LowEntryJsonObject): LowEntryJsonObjectIterator;
	static CloneJsonObjectIterator(JsonObjectIterator: LowEntryJsonObjectIterator): LowEntryJsonObjectIterator;
	static CreateJsonObjectEntry(Key: string,Value: string): LowEntryJsonObjectEntry;
	static CreateJsonObjectEntry(Key: string): LowEntryJsonObjectEntry;
	static CreateJsonObjectEntry(Key: string,Value: LowEntryJsonObject): LowEntryJsonObjectEntry;
	static CreateJsonObjectEntry(Key: string,Value: LowEntryJsonArray): LowEntryJsonObjectEntry;
	static CreateJsonObjectEntry(Key: string,Value: number): LowEntryJsonObjectEntry;
	static CreateJsonObjectEntry(Key: string,Value: number): LowEntryJsonObjectEntry;
	static CreateJsonObjectEntry(Key: string,Value: number): LowEntryJsonObjectEntry;
	static CreateJsonObjectEntry(Key: string,Value: boolean): LowEntryJsonObjectEntry;
	static CreateJsonObjectEntry(Key: string,Value: LowEntryJsonValue): LowEntryJsonObjectEntry;
	static Unset(JsonObject: LowEntryJsonObject,Key: string): void;
	static ToJsonString(JsonObject: LowEntryJsonObject,PrettyPrint: boolean): string;
	static Sort(JsonObject: LowEntryJsonObject,Reversed: boolean): void;
	static SetString(JsonObject: LowEntryJsonObject,Key: string,Value: string): void;
	static SetNull(JsonObject: LowEntryJsonObject,Key: string): void;
	static SetJsonValue(JsonObject: LowEntryJsonObject,Key: string,Value: LowEntryJsonValue): void;
	static SetJsonObject(JsonObject: LowEntryJsonObject,Key: string,Value: LowEntryJsonObject): void;
	static SetJsonArray(JsonObject: LowEntryJsonObject,Key: string,Value: LowEntryJsonArray): void;
	static SetInteger(JsonObject: LowEntryJsonObject,Key: string,Value: number): void;
	static SetFloat(JsonObject: LowEntryJsonObject,Key: string,Value: number): void;
	static SetByte(JsonObject: LowEntryJsonObject,Key: string,Value: number): void;
	static SetBoolean(JsonObject: LowEntryJsonObject,Key: string,Value: boolean): void;
	static ToJsonString(JsonObject: LowEntryJsonObject,PrettyPrint: boolean): string;
	static Merge(JsonObject1: LowEntryJsonObject,JsonObject2: LowEntryJsonObject): LowEntryJsonObject;
	static CreateJsonObject(Array: LowEntryJsonObjectEntry[]): LowEntryJsonObject;
	static Clone(JsonObject: LowEntryJsonObject): LowEntryJsonObject;
	static Merge(JsonObject1: LowEntryJsonObject,JsonObject2: LowEntryJsonObject): LowEntryJsonObject;
	static Length(JsonObject: LowEntryJsonObject): number;
	static IsSet(JsonObject: LowEntryJsonObject,Key: string): boolean;
	static GetValues(JsonObject: LowEntryJsonObject): LowEntryJsonArray;
	static GetString(JsonObject: LowEntryJsonObject,Key: string,Branch?: ELowEntryJsonValueAndTypeFound): {Branch: ELowEntryJsonValueAndTypeFound, $: string};
	static GetNull(JsonObject: LowEntryJsonObject,Key: string,Branch?: ELowEntryJsonValueAndTypeFound): {Branch: ELowEntryJsonValueAndTypeFound};
	static GetKeys(JsonObject: LowEntryJsonObject): string[];
	static GetJsonValue(JsonObject: LowEntryJsonObject,Key: string,Branch?: ELowEntryJsonValueFound): {Branch: ELowEntryJsonValueFound, $: LowEntryJsonValue};
	static GetJsonObject(JsonObject: LowEntryJsonObject,Key: string,Branch?: ELowEntryJsonValueAndTypeFound): {Branch: ELowEntryJsonValueAndTypeFound, $: LowEntryJsonObject};
	static GetJsonArray(JsonObject: LowEntryJsonObject,Key: string,Branch?: ELowEntryJsonValueAndTypeFound): {Branch: ELowEntryJsonValueAndTypeFound, $: LowEntryJsonArray};
	static GetInteger(JsonObject: LowEntryJsonObject,Key: string,Branch?: ELowEntryJsonValueAndTypeFound): {Branch: ELowEntryJsonValueAndTypeFound, $: number};
	static GetFloat(JsonObject: LowEntryJsonObject,Key: string,Branch?: ELowEntryJsonValueAndTypeFound): {Branch: ELowEntryJsonValueAndTypeFound, $: number};
	static GetByte(JsonObject: LowEntryJsonObject,Key: string,Branch?: ELowEntryJsonValueAndTypeFound): {Branch: ELowEntryJsonValueAndTypeFound, $: number};
	static GetBoolean(JsonObject: LowEntryJsonObject,Key: string,Branch?: ELowEntryJsonValueAndTypeFound): {Branch: ELowEntryJsonValueAndTypeFound, $: boolean};
	static GetAsString(JsonObject: LowEntryJsonObject,Key: string,Default: string): string;
	static GetAsJsonValue(JsonObject: LowEntryJsonObject,Key: string,Default: LowEntryJsonValue): LowEntryJsonValue;
	static GetAsJsonObject(JsonObject: LowEntryJsonObject,Key: string,Default: LowEntryJsonObject): LowEntryJsonObject;
	static GetAsJsonArray(JsonObject: LowEntryJsonObject,Key: string,Default: LowEntryJsonArray): LowEntryJsonArray;
	static GetAsInteger(JsonObject: LowEntryJsonObject,Key: string,Default: number): number;
	static GetAsFloat(JsonObject: LowEntryJsonObject,Key: string,Default: number): number;
	static GetAsByte(JsonObject: LowEntryJsonObject,Key: string,Default: number): number;
	static GetAsBoolean(JsonObject: LowEntryJsonObject,Key: string,Default: boolean): boolean;
	static Get(JsonObject: LowEntryJsonObject,Key: string,Branch?: ELowEntryJsonType,ReturnStringValue?: string,ReturnIntegerValue?: number,ReturnFloatValue?: number,ReturnByteValue?: number,ReturnBooleanValue?: boolean,ReturnJsonObjectValue?: LowEntryJsonObject,ReturnJsonArrayValue?: LowEntryJsonArray): {Branch: ELowEntryJsonType, ReturnStringValue: string, ReturnIntegerValue: number, ReturnFloatValue: number, ReturnByteValue: number, ReturnBooleanValue: boolean, ReturnJsonObjectValue: LowEntryJsonObject, ReturnJsonArrayValue: LowEntryJsonArray};
	static CreateJsonObject(Array: LowEntryJsonObjectEntry[]): LowEntryJsonObject;
	static Clone(JsonObject: LowEntryJsonObject): LowEntryJsonObject;
	static Clear(JsonObject: LowEntryJsonObject): void;
	static Append(JsonObject: LowEntryJsonObject,AppendJsonObject: LowEntryJsonObject,OverrideDuplicates: boolean): void;
	static ParseJsonString(JsonString: string,ReturnJsonObjectValue?: LowEntryJsonObject,ReturnJsonArrayValue?: LowEntryJsonArray,Branch?: ELowEntryJsonParseResult): {ReturnJsonObjectValue: LowEntryJsonObject, ReturnJsonArrayValue: LowEntryJsonArray, Branch: ELowEntryJsonParseResult};
	static Unset(JsonArray: LowEntryJsonArray,Index: number,Count: number): void;
	static ToJsonString(JsonArray: LowEntryJsonArray,PrettyPrint: boolean): string;
	static Shorten(JsonArray: LowEntryJsonArray,Size: number): void;
	static SetString(JsonArray: LowEntryJsonArray,Index: number,Value: string): void;
	static SetNull(JsonArray: LowEntryJsonArray,Index: number): void;
	static SetJsonValue(JsonArray: LowEntryJsonArray,Index: number,Value: LowEntryJsonValue): void;
	static SetJsonObject(JsonArray: LowEntryJsonArray,Index: number,Value: LowEntryJsonObject): void;
	static SetJsonArray(JsonArray: LowEntryJsonArray,Index: number,Value: LowEntryJsonArray): void;
	static SetInteger(JsonArray: LowEntryJsonArray,Index: number,Value: number): void;
	static SetFloat(JsonArray: LowEntryJsonArray,Index: number,Value: number): void;
	static SetByte(JsonArray: LowEntryJsonArray,Index: number,Value: number): void;
	static SetBoolean(JsonArray: LowEntryJsonArray,Index: number,Value: boolean): void;
	static Resize(JsonArray: LowEntryJsonArray,Size: number): void;
	static ToJsonString(JsonArray: LowEntryJsonArray,PrettyPrint: boolean): string;
	static Merge(JsonArray1: LowEntryJsonArray,JsonArray2: LowEntryJsonArray): LowEntryJsonArray;
	static CreateJsonArray(Value: string[]): LowEntryJsonArray;
	static CreateJsonArray(Value: LowEntryJsonValue[]): LowEntryJsonArray;
	static CreateJsonArray(Value: LowEntryJsonObject[]): LowEntryJsonArray;
	static CreateJsonArray(Value: LowEntryJsonArray[]): LowEntryJsonArray;
	static CreateJsonArray(Value: number[]): LowEntryJsonArray;
	static CreateJsonArray(Value: number[]): LowEntryJsonArray;
	static CreateJsonArray(Value: number[]): LowEntryJsonArray;
	static CreateJsonArray(Value: boolean[]): LowEntryJsonArray;
	static Clone(JsonArray: LowEntryJsonArray): LowEntryJsonArray;
	static Merge(JsonArray1: LowEntryJsonArray,JsonArray2: LowEntryJsonArray): LowEntryJsonArray;
	static Length(JsonArray: LowEntryJsonArray): number;
	static IsSet(JsonArray: LowEntryJsonArray,Index: number): boolean;
	static InsertString(JsonArray: LowEntryJsonArray,Index: number,Value: string): void;
	static InsertNull(JsonArray: LowEntryJsonArray,Index: number): void;
	static InsertJsonValue(JsonArray: LowEntryJsonArray,Index: number,Value: LowEntryJsonValue): void;
	static InsertJsonObject(JsonArray: LowEntryJsonArray,Index: number,Value: LowEntryJsonObject): void;
	static InsertJsonArray(JsonArray: LowEntryJsonArray,Index: number,Value: LowEntryJsonArray): void;
	static InsertInteger(JsonArray: LowEntryJsonArray,Index: number,Value: number): void;
	static InsertFloat(JsonArray: LowEntryJsonArray,Index: number,Value: number): void;
	static InsertByte(JsonArray: LowEntryJsonArray,Index: number,Value: number): void;
	static InsertBoolean(JsonArray: LowEntryJsonArray,Index: number,Value: boolean): void;
	static GetString(JsonArray: LowEntryJsonArray,Index: number,Branch?: ELowEntryJsonValueAndTypeFound): {Branch: ELowEntryJsonValueAndTypeFound, $: string};
	static GetNull(JsonArray: LowEntryJsonArray,Index: number,Branch?: ELowEntryJsonValueAndTypeFound): {Branch: ELowEntryJsonValueAndTypeFound};
	static GetJsonValue(JsonArray: LowEntryJsonArray,Index: number,Branch?: ELowEntryJsonValueFound): {Branch: ELowEntryJsonValueFound, $: LowEntryJsonValue};
	static GetJsonObject(JsonArray: LowEntryJsonArray,Index: number,Branch?: ELowEntryJsonValueAndTypeFound): {Branch: ELowEntryJsonValueAndTypeFound, $: LowEntryJsonObject};
	static GetJsonArray(JsonArray: LowEntryJsonArray,Index: number,Branch?: ELowEntryJsonValueAndTypeFound): {Branch: ELowEntryJsonValueAndTypeFound, $: LowEntryJsonArray};
	static GetInteger(JsonArray: LowEntryJsonArray,Index: number,Branch?: ELowEntryJsonValueAndTypeFound): {Branch: ELowEntryJsonValueAndTypeFound, $: number};
	static GetFloat(JsonArray: LowEntryJsonArray,Index: number,Branch?: ELowEntryJsonValueAndTypeFound): {Branch: ELowEntryJsonValueAndTypeFound, $: number};
	static GetByte(JsonArray: LowEntryJsonArray,Index: number,Branch?: ELowEntryJsonValueAndTypeFound): {Branch: ELowEntryJsonValueAndTypeFound, $: number};
	static GetBoolean(JsonArray: LowEntryJsonArray,Index: number,Branch?: ELowEntryJsonValueAndTypeFound): {Branch: ELowEntryJsonValueAndTypeFound, $: boolean};
	static GetAsString(JsonArray: LowEntryJsonArray,Index: number,Default: string): string;
	static GetAsJsonValue(JsonArray: LowEntryJsonArray,Index: number,Default: LowEntryJsonValue): LowEntryJsonValue;
	static GetAsJsonObject(JsonArray: LowEntryJsonArray,Index: number,Default: LowEntryJsonObject): LowEntryJsonObject;
	static GetAsJsonArray(JsonArray: LowEntryJsonArray,Index: number,Default: LowEntryJsonArray): LowEntryJsonArray;
	static GetAsInteger(JsonArray: LowEntryJsonArray,Index: number,Default: number): number;
	static GetAsFloat(JsonArray: LowEntryJsonArray,Index: number,Default: number): number;
	static GetAsByte(JsonArray: LowEntryJsonArray,Index: number,Default: number): number;
	static GetAsBoolean(JsonArray: LowEntryJsonArray,Index: number,Default: boolean): boolean;
	static Get(JsonArray: LowEntryJsonArray,Index: number,Branch?: ELowEntryJsonType,ReturnStringValue?: string,ReturnIntegerValue?: number,ReturnFloatValue?: number,ReturnByteValue?: number,ReturnBooleanValue?: boolean,ReturnJsonObjectValue?: LowEntryJsonObject,ReturnJsonArrayValue?: LowEntryJsonArray): {Branch: ELowEntryJsonType, ReturnStringValue: string, ReturnIntegerValue: number, ReturnFloatValue: number, ReturnByteValue: number, ReturnBooleanValue: boolean, ReturnJsonObjectValue: LowEntryJsonObject, ReturnJsonArrayValue: LowEntryJsonArray};
	static Expand(JsonArray: LowEntryJsonArray,Size: number): void;
	static CreateJsonArray(Value: string[]): LowEntryJsonArray;
	static CreateJsonArray(Value: LowEntryJsonValue[]): LowEntryJsonArray;
	static CreateJsonArray(Value: LowEntryJsonObject[]): LowEntryJsonArray;
	static CreateJsonArray(Value: LowEntryJsonArray[]): LowEntryJsonArray;
	...
	static CreateJsonArray(Value: boolean[]): LowEntryJsonArray;
	static Clone(JsonArray: LowEntryJsonArray): LowEntryJsonArray;
	static Clear(JsonArray: LowEntryJsonArray): void;
	static Append(JsonArray: LowEntryJsonArray,AppendJsonArray: LowEntryJsonArray): void;
	static AddString(JsonArray: LowEntryJsonArray,Value: string): void;
	static AddNull(JsonArray: LowEntryJsonArray): void;
	static AddJsonValue(JsonArray: LowEntryJsonArray,Value: LowEntryJsonValue): void;
	static AddJsonObject(JsonArray: LowEntryJsonArray,Value: LowEntryJsonObject): void;
	static AddJsonArray(JsonArray: LowEntryJsonArray,Value: LowEntryJsonArray): void;
	static AddInteger(JsonArray: LowEntryJsonArray,Value: number): void;
	static AddFloat(JsonArray: LowEntryJsonArray,Value: number): void;
	static AddByte(JsonArray: LowEntryJsonArray,Value: number): void;
	static AddBoolean(JsonArray: LowEntryJsonArray,Value: boolean): void;
	static C(Other: UObject): LowEntryJsonLibrary;
}
...
declare class Demo extends UObject { 
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): Demo;
	static Find(Outer: UObject, ResourceName: string): Demo;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): Demo;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): Demo;
	static C(Other: UObject): Demo;
}
...
declare class K2Node_LowEntry_CreateJsonArray extends K2Node { 
	NumInputs: number;
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): K2Node_LowEntry_CreateJsonArray;
	static Find(Outer: UObject, ResourceName: string): K2Node_LowEntry_CreateJsonArray;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): K2Node_LowEntry_CreateJsonArray;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): K2Node_LowEntry_CreateJsonArray;
	static C(Other: UObject): K2Node_LowEntry_CreateJsonArray;
}

declare class K2Node_LowEntry_CreateJsonArrayPure extends K2Node { 
	NumInputs: number;
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): K2Node_LowEntry_CreateJsonArrayPure;
	static Find(Outer: UObject, ResourceName: string): K2Node_LowEntry_CreateJsonArrayPure;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): K2Node_LowEntry_CreateJsonArrayPure;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): K2Node_LowEntry_CreateJsonArrayPure;
	static C(Other: UObject): K2Node_LowEntry_CreateJsonArrayPure;
}

declare class K2Node_LowEntry_CreateJsonObject extends K2Node { 
	NumInputs: number;
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): K2Node_LowEntry_CreateJsonObject;
	static Find(Outer: UObject, ResourceName: string): K2Node_LowEntry_CreateJsonObject;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): K2Node_LowEntry_CreateJsonObject;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): K2Node_LowEntry_CreateJsonObject;
	static C(Other: UObject): K2Node_LowEntry_CreateJsonObject;
}

declare class K2Node_LowEntry_CreateJsonObjectPure extends K2Node { 
	NumInputs: number;
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): K2Node_LowEntry_CreateJsonObjectPure;
	static Find(Outer: UObject, ResourceName: string): K2Node_LowEntry_CreateJsonObjectPure;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): K2Node_LowEntry_CreateJsonObjectPure;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): K2Node_LowEntry_CreateJsonObjectPure;
	static C(Other: UObject): K2Node_LowEntry_CreateJsonObjectPure;
}

declare class TungstenDesktopDuplicationInstance extends UObject { 
	...
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): TungstenDesktopDuplicationInstance;
	static Find(Outer: UObject, ResourceName: string): TungstenDesktopDuplicationInstance;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): TungstenDesktopDuplicationInstance;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): TungstenDesktopDuplicationInstance;
	TakeScreenshot(Path: string,IsSuccess?: boolean): {IsSuccess: boolean};
	StartDuplicate(IsSuccess?: boolean): {IsSuccess: boolean};
	EndDuplicate(): void;
	DestroyDesktopDuplicationInstance(): void;
	static CreateDesktopDuplicationInstance(): TungstenDesktopDuplicationInstance;
	static C(Other: UObject): TungstenDesktopDuplicationInstance;
}
...
declare class TRASHCLASS_FeaturePacks_3 { 
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): TRASHCLASS_FeaturePacks_3;
	static Find(Outer: UObject, ResourceName: string): TRASHCLASS_FeaturePacks_3;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): TRASHCLASS_FeaturePacks_3;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): TRASHCLASS_FeaturePacks_3;
	static C(Other: UObject): TRASHCLASS_FeaturePacks_3;
}
...
declare class TRASHCLASS_LevelEditorAttract_5 { 
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): TRASHCLASS_LevelEditorAttract_5;
	static Find(Outer: UObject, ResourceName: string): TRASHCLASS_LevelEditorAttract_5;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): TRASHCLASS_LevelEditorAttract_5;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): TRASHCLASS_LevelEditorAttract_5;
	static C(Other: UObject): TRASHCLASS_LevelEditorAttract_5;
}

declare class ORPHANED_DATA_ONLY_LevelEditorAttract_C_6 { 
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): ORPHANED_DATA_ONLY_LevelEditorAttract_C_6;
	static Find(Outer: UObject, ResourceName: string): ORPHANED_DATA_ONLY_LevelEditorAttract_C_6;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): ORPHANED_DATA_ONLY_LevelEditorAttract_C_6;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): ORPHANED_DATA_ONLY_LevelEditorAttract_C_6;
	static C(Other: UObject): ORPHANED_DATA_ONLY_LevelEditorAttract_C_6;
}

declare class TRASHCLASS_LevelBlueprintEditorOverview_7 { 
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): TRASHCLASS_LevelBlueprintEditorOverview_7;
	static Find(Outer: UObject, ResourceName: string): TRASHCLASS_LevelBlueprintEditorOverview_7;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): TRASHCLASS_LevelBlueprintEditorOverview_7;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): TRASHCLASS_LevelBlueprintEditorOverview_7;
	static C(Other: UObject): TRASHCLASS_LevelBlueprintEditorOverview_7;
}

declare class ORPHANED_DATA_ONLY_LevelBlueprintEditorOverview_C_8 { 
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): ORPHANED_DATA_ONLY_LevelBlueprintEditorOverview_C_8;
	static Find(Outer: UObject, ResourceName: string): ORPHANED_DATA_ONLY_LevelBlueprintEditorOverview_C_8;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): ORPHANED_DATA_ONLY_LevelBlueprintEditorOverview_C_8;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): ORPHANED_DATA_ONLY_LevelBlueprintEditorOverview_C_8;
	static C(Other: UObject): ORPHANED_DATA_ONLY_LevelBlueprintEditorOverview_C_8;
}

declare class TRASHCLASS_PersonaAnimEditorWalkthrough_9 { 
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): TRASHCLASS_PersonaAnimEditorWalkthrough_9;
	static Find(Outer: UObject, ResourceName: string): TRASHCLASS_PersonaAnimEditorWalkthrough_9;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): TRASHCLASS_PersonaAnimEditorWalkthrough_9;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): TRASHCLASS_PersonaAnimEditorWalkthrough_9;
	static C(Other: UObject): TRASHCLASS_PersonaAnimEditorWalkthrough_9;
}

declare class ORPHANED_DATA_ONLY_PersonaAnimEditorWalkthrough_C_10 { 
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): ORPHANED_DATA_ONLY_PersonaAnimEditorWalkthrough_C_10;
	static Find(Outer: UObject, ResourceName: string): ORPHANED_DATA_ONLY_PersonaAnimEditorWalkthrough_C_10;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): ORPHANED_DATA_ONLY_PersonaAnimEditorWalkthrough_C_10;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): ORPHANED_DATA_ONLY_PersonaAnimEditorWalkthrough_C_10;
	static C(Other: UObject): ORPHANED_DATA_ONLY_PersonaAnimEditorWalkthrough_C_10;
}

declare class TRASHCLASS_PersonaAnimBlueprintEditorWalkthrough_11 { 
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): TRASHCLASS_PersonaAnimBlueprintEditorWalkthrough_11;
	static Find(Outer: UObject, ResourceName: string): TRASHCLASS_PersonaAnimBlueprintEditorWalkthrough_11;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): TRASHCLASS_PersonaAnimBlueprintEditorWalkthrough_11;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): TRASHCLASS_PersonaAnimBlueprintEditorWalkthrough_11;
	static C(Other: UObject): TRASHCLASS_PersonaAnimBlueprintEditorWalkthrough_11;
}

declare class ORPHANED_DATA_ONLY_PersonaAnimBlueprintEditorWalkthrough_C_12 { 
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): ORPHANED_DATA_ONLY_PersonaAnimBlueprintEditorWalkthrough_C_12;
	static Find(Outer: UObject, ResourceName: string): ORPHANED_DATA_ONLY_PersonaAnimBlueprintEditorWalkthrough_C_12;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): ORPHANED_DATA_ONLY_PersonaAnimBlueprintEditorWalkthrough_C_12;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): ORPHANED_DATA_ONLY_PersonaAnimBlueprintEditorWalkthrough_C_12;
	static C(Other: UObject): ORPHANED_DATA_ONLY_PersonaAnimBlueprintEditorWalkthrough_C_12;
}
